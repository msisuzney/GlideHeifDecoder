...
public class HeifBitmapFactory {
    private static final int IN_TEMP_BUFFER_SIZE = 8 * 1024;


    static {
        System.loadLibrary("heifdecoder");
    }
    ...
    /**
     * 设置heif的BitmapOptions
     *
     * @param bitmap
     * @param opts
     */
    private static void setHeifBitmapOptions(Bitmap bitmap, BitmapFactory.Options opts) {
        setDensityFromOptions(bitmap, opts);
//        if (opts != null) {
//            opts.outMimeType = "image/avif";
//        }
    }
    ...
    public static Bitmap decodeByteArray(byte[] data, int offset, int length, BitmapFactory.Options opts) {
        ...
        Bitmap bm = nativeDecodeByteArray(data, offset, length, opts, opts == null ? 1 : opts.inSampleSize,
                getInTempStorageFromOptions(opts));
        setHeifBitmapOptions(bm, opts);
        return bm;
    }
    ...
    public static Bitmap decodeFileDescriptor(FileDescriptor fd, Rect outPadding, BitmapFactory.Options opts) {
        ...
        try {
            bm = nativeDecodeStream(is, opts, opts == null ? 1 : opts.inSampleSize, getInTempStorageFromOptions(opts));
            setHeifBitmapOptions(bm, opts);
    ...
    private static native Bitmap nativeDecodeStream(InputStream is, BitmapFactory.Options opts,
                                                    int sampleSize, byte[] inTempStorage);
